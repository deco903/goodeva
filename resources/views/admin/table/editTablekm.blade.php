                        ...
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>No</label>
                                    <input type="number" name="no" class="form-control" placeholder="No" value="{{$pribadi->no}}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Destinasi Keberangkatan</label>
                                    <select name="keberangkatan" id="inputState" class="form-control" value="{{$pribadi->keberangkatan}}">
                                    <option selected>Pilih Keberangkatan...</option>
                                        <option value="Jakarta" {{ $pribadi->keberangkatan =='Jakarta'?'selected':'' }}>Jakarta</option>
                                        <option value="Bandung" {{ $pribadi->keberangkatan =='Bandung'?'selected':'' }}>Bandung</option>
                                        <option value="Madura" {{ $pribadi->keberangkatan =='Madura'?'selected':'' }}>Madura</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Nama Kapal</label>
                                    <input type="text" name="nama_kapal" class="form-control" placeholder="Nama Kapal" value="{{$pribadi->nama_kapal}}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Destinasi Tujuan</label>
                                    <select name="tujuan" id="inputState" class="form-control" {{$pribadi->tujuan}}>
                                    <option selected>Pilih Keberangkatan...</option>
                                        <option value="Jakarta" {{ $pribadi->tujuan =='Jakarta'?'selected':'' }}>Jakarta</option>
                                        <option value="Bandung" {{ $pribadi->tujuan =='Bandung'?'selected':'' }}>Bandung</option>
                                        <option value="Madura" {{ $pribadi->tujuan =='Madura'?'selected':'' }}>Madura</option>
                                    </select>
                                </div>
                                <!-- <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="dateMounth">
                                        <input type="date" name="mulai_sewa" id="" class="dateTerm" value="{{$pribadi->mulai_sewa}}">
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Nama Penyewa</label>
                                    <input type="text" name="nama_penyewa" class="form-control" placeholder="Nama Penyewa" value="{{$pribadi->nama_penyewa}}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Sewa Selesai</label>
                                    <div class="dateMounth">
                                        <input type="date" name="sewa_selesai" id="" class="dateTerm" value="{{$pribadi->sewa_selesai}}">
                                    </div>
                                </div>

                                <div class="mb-3">
                                    <label for="image" class="form-label">Masukan Gambar</label>
                                    <input class="form-control @error('image') is-invalid @enderror" type="file" id="image" name="image" value="{{$pribadi->image}}">
                                </div>
                                <div class="form-group col-md-6">
                                    <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    <textarea name="keterangan" class="form-control" rows="4" id="comment" placeholder="Note">{{$pribadi->keterangan}}</textarea>
                                </div>
