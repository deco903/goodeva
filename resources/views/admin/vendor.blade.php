            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <div class="page-header">
                        ...
                        <form action="{{route('carivendor')}}" method="GET">   
                        @csrf 
                            <div class="input-group inputSearch mb-4 border rounded-pill p-1">
                                ...
                                <input type="search" id="nama_perusahaan" placeholder="Pencarian.." aria-describedby="button-addon4" class="form-control bg-one border-0">
                            </div>
                        </form>
